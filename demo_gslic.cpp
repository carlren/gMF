...
void load_image(const Mat& inimg, gSLIC::UChar3Image* outimg)
{
	gSLIC::Vector3u* outimg_ptr = outimg->GetData(MEMORYDEVICE_CPU);
...
void load_image(const gSLIC::UChar3Image* inimg, Mat& outimg)
{
	const gSLIC::Vector3u* inimg_ptr = inimg->GetData(MEMORYDEVICE_CPU);
...
int main()
{
	...
	gSLIC::UChar3Image* in_img = new gSLIC::UChar3Image(my_settings.img_size, true, true);
	gSLIC::UChar3Image* out_img = new gSLIC::UChar3Image(my_settings.img_size, true, true);
